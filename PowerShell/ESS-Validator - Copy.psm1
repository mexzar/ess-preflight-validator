...
function Test-ESSEnvironment {
    ...
    try {
        ...
        if ($environment.EnvironmentType -eq 'Managed') {
            ...
            Add-ValidationResult -CheckpointId 'ENV-003' -Category 'Environment' -Priority 'High' -Status 'Warning' `
                -Result "Environment is not a Managed Environment (Type: $($environment.EnvironmentType))" `
                -Remediation "Consider converting to a Managed Environment for better governance and security features." `
                -DocumentationLink 'https://learn.microsoft.com/en-us/copilot/microsoft-365/employee-self-service/prepare#set-up-your-power-platform-environment'
        }
        ...
        try {
            ...
            $dlpPolicies = Get-DlpPolicy -EnvironmentName $EnvironmentId
            ...
            Add-ValidationResult -CheckpointId 'ENV-008' -Category 'Environment' -Priority 'High' -Status 'Failed' `
                -Result "Unable to check DLP policies: $_"
        }
